...
(() => {
  const THEMES = {
    sunset: {
      name: 'Sunset (Default)',
      bg: '#EDEAE2', bgAlt: '#E4E0D6', ink: '#181716', inkSoft: '#4A463E',
      muted: '#8A867C', line: '#D8D3C6', accentA: '#FF4E1F', accentB: '#1E4CFF',
    },
    emerald: {
      name: 'Emerald Dusk',
      bg: '#E7EDE7', bgAlt: '#DCE4DC', ink: '#14201B', inkSoft: '#3E4A44',
      muted: '#7C8B83', line: '#CBD6CD', accentA: '#FF9F1C', accentB: '#1F8A5F',
    },
    crimson: {
      name: 'Crimson Slate',
      bg: '#EAEAF0', bgAlt: '#DFE0E8', ink: '#17171F', inkSoft: '#3E3F4C',
      muted: '#82838F', line: '#CCCDDA', accentA: '#E63946', accentB: '#3A3AFF',
    },
    violet: {
      name: 'Violet Copper',
      bg: '#EFEAE4', bgAlt: '#E5DED4', ink: '#201A16', inkSoft: '#4A3F37',
      muted: '#8C8074', line: '#D9CFC2', accentA: '#D9722C', accentB: '#7C5CFF',
    },
  };
