...
(() => {
  ...
  const DEFAULTS = {
    ...
    portfolio: [
      { id: 'collect',            title: 'Collect',               category: 'mobile', description: 'Own core features on Collect, a React Native app at Mitti Labs connecting 1,000+ registered farmers to a carbon-monitoring and sustainability tracking workflow.', thumbnail: null, thumbnailPath: null, playStoreUrl: 'https://play.google.com/store/apps/details?id=com.mitticollect', githubUrl: null },
      { id: 'thebidnow',          title: 'TheBidNow',              category: 'api',    description: 'Built the real-time WebSocket bidding engine powering concurrent live auctions across 4 sports, with sub-200ms response time and OTP auth.', thumbnail: null, thumbnailPath: null, playStoreUrl: 'https://play.google.com/store/apps/details?id=com.thebidnow.auction&hl=en', githubUrl: null },
      { id: 'amulya-mica',        title: 'Amulya Mica Visualizer', category: 'design', description: 'Built an AR-style product visualization experience at 60fps, reducing purchase-stage drop-off with an interactive preview.', thumbnail: null, thumbnailPath: null, playStoreUrl: 'https://play.google.com/store/apps/details?id=com.amulyamicavisualizer.amulyamicavisualizer', githubUrl: null },
      { id: 'satvvaahar',         title: 'Satvvaahar',             category: 'mobile', description: 'Shipped Satvvaahar, a food-ordering app with real-time push notifications and order/profile state management.', thumbnail: null, thumbnailPath: null, playStoreUrl: 'https://play.google.com/store/apps/details?id=com.milople.satvaahar&hl=en', githubUrl: null },
      { id: 'spjym',              title: 'SPJYM',                  category: 'mobile', description: 'Shipped SPJYM (Shree Prarthna Jain Yuvak Mandal), a community-events app with real-time push notifications and profile state management.', thumbnail: null, thumbnailPath: null, playStoreUrl: 'https://play.google.com/store/apps/details?id=com.spjym.shreeprarthnajainyuvak&hl=en', githubUrl: null },
      { id: 'magento-app',        title: 'Magento Mobile App',     category: 'mobile', description: 'Built an e-commerce app on the Magento REST API with product browsing, cart, and an integration-tested checkout flow.', thumbnail: null, thumbnailPath: null, playStoreUrl: 'https://play.google.com/store/apps/details?id=com.milople.milople&hl=en', githubUrl: null },
      { id: 'notenest',           title: 'NoteNest',               category: 'mobile', description: 'An offline-first notes app built solo with Provider and Hive, demonstrating clean architecture and local storage.', thumbnail: null, thumbnailPath: null, playStoreUrl: null, githubUrl: 'https://github.com/shahshubham9090/flutter-notenest-app' },
    ],
  };
